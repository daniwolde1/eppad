...
export default function Conference2025Page() {
  ...
  className="px-6 py-3 text-lg bg-blue-600 text-white hover:bg-blue-700 transition"
>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-4 p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-lg text-foreground mb-1">
                          Dr. Tesfaye Biftu, PhD, MBA
                        </h3>
                        <p className="text-sm text-primary font-medium mb-2">
                          "An Exemplar of Expertise in Drug Discovery"
                        </p>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Raised in Agaro, a Coffee Growing Village in Ethiopia, to one of the most
                          influential medicinal chemists in the USA. A pioneering researcher with 65+
                          patents and key contributions to breakthrough medications.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Full Professor at Howard University, Fulbright Scholar, and accomplished
                          researcher with over 50 publications. A guide to balancing professional
                          excellence with personal fulfillment.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4 p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          PhD in Natural Products Chemistry with 175+ publications and author of 8 books.
                          A comprehensive exploration of Ethiopia's rich heritage of traditional medicine
                          and healing plants.
                        </p>
                      </div>
                    </div>
                ...
                <div className="border-t border-border pt-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        EPPAD is a non-profit organization dedicated to promoting public health through
                        pharmacy care in the United States and Ethiopia. We bring together Ethiopian
                        pharmacists and pharmaceutical scientists to advance the profession and serve our
                        communities.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-card rounded-lg border border-border p-6 shadow-xl sticky top-24">
                ...
                <div className="bg-muted/50 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Oct 15, 2025 9:03 AM - Nov 8, 2025 3:30 PM EST
                  </p>
                </div>
